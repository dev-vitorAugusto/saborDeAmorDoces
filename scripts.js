...
fetch('/api/produtos')
  ...
  .then(data => {
    ...
    for (let i = 1; i < rows.length; i++) {
      ...
      const preco = row[3] ? row[3].toString().replace(',', '.') : 'Sem preço';
  ...
  <div class="card border-0 mb-3" style="width: 17rem;">
    <img src="${img}" class="card-img-top" alt="..." width="450px" height="250px">
    <div class="card-body">
